        ...
        methods: {
            ...
            hidePop(data) {
                if (this.currentSalary) {
                    this.putRequest('/pims/salary/sobcfg/?eid=' + data.id + '&sid=' + this.currentSalary).then(resp => {
                        if (resp) {
                            this.initEmps()
                        }
                    });
            ...
            initSalaries() {
                this.getRequest("/pims/salary/sobcfg/salaries").then(resp => {
                    if (resp) {
                        this.salaries = resp;
                    }
                })
            ...
            initEmps() {
                this.getRequest("/pims/salary/sobcfg/?page=" + this.currentPage + '&size=' + this.currentSize).then(resp => {
                    if (resp) {
                        this.emps = resp.data;
